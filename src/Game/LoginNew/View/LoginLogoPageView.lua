...
---@class LoginLogoPageView : UIView
...
---@field AnimClickBack UWidgetAnimation
...
local LoginLogoPageView = LuaClass(UIView, true)

function LoginLogoPageView:Ctor()
...
function LoginLogoPageView:OnRegisterSubView()
	--AUTO GENERATED CODE 2 BEGIN, PLEASE DON'T MODIFY
	--AUTO GENERATED CODE 2 END, PLEASE DON'T MODIFY
end

function LoginLogoPageView:OnInit()
end

function LoginLogoPageView:OnDestroy()
...
function LoginLogoPageView:OnHide()

end

function LoginLogoPageView:OnRegisterUIEvent()

end

function LoginLogoPageView:OnRegisterGameEvent()

end

function LoginLogoPageView:OnRegisterBinder()

end

return LoginLogoPageView