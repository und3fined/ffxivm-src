...
---@class MysterMerchantBuyPropsWinNewView : UIView
...
local MysterMerchantBuyPropsWinNewView = LuaClass(UIView, true)

function MysterMerchantBuyPropsWinNewView:Ctor()
...
function MysterMerchantBuyPropsWinNewView:OnRegisterSubView()
...
function MysterMerchantBuyPropsWinNewView:OnInit()
	self.MaxNum = nil
	self.GoodsId = nil
...
function MysterMerchantBuyPropsWinNewView:OnDestroy()

end

function MysterMerchantBuyPropsWinNewView:SetLSTR()
...
function MysterMerchantBuyPropsWinNewView:OnShow()
	self:SetLSTR()
	self.AllSurplus = 0
	self.CurNum = 1
...
function MysterMerchantBuyPropsWinNewView:OnHide()
	self.TextAmount:SetText(1)
...
function MysterMerchantBuyPropsWinNewView:OnRegisterUIEvent()
...
function MysterMerchantBuyPropsWinNewView:OnRegisterGameEvent()
	self:RegisterGameEvent(EventID.ScoreUpdate, self.UpdateTextColor)
end

function MysterMerchantBuyPropsWinNewView:OnRegisterBinder()

end

function MysterMerchantBuyPropsWinNewView:UpdateGoodsInfo()
...
function MysterMerchantBuyPropsWinNewView:SetTitle()
...
function MysterMerchantBuyPropsWinNewView:SetDiscount(Info)
...
function MysterMerchantBuyPropsWinNewView:SetQuota(QuotaInfo, OnceLimitation)
	if QuotaInfo.RestrictionType and QuotaInfo.RestrictionType ~= 0 then
		...
		if CanBuyCount <= 0 then
			...
			-- 		self.RightTopNum:SetText(string.format("%s:%d", LSTR(1110015), AllSurplus))--商品剩余量
			-- 	end
			-- end
		else
...
function MysterMerchantBuyPropsWinNewView:SetBindState()
	local Item = ItemUtil.CreateItem(self.ItemID, 0)
	ItemTipsUtil.ShowTipsByItem(Item, self.ImgGoods)
end

function MysterMerchantBuyPropsWinNewView:SetPriceInfo(PriceInfo)
	local PriceValue = 0
...
function MysterMerchantBuyPropsWinNewView:SetSlider()
...
function MysterMerchantBuyPropsWinNewView:SetNumberPanel(PanelList)
	--走配置 显示便携数量选择
	local IsShow = true
	for i = 1,#PanelList do 
...
function MysterMerchantBuyPropsWinNewView:SetNumberPanelByOnceLimitation(PanelList,OnceLimitation)
	--走配置
	if OnceLimitation == 1 then
		local IsShow = false
		for i = 1,#PanelList do 
...
function MysterMerchantBuyPropsWinNewView:OnValueChangedSlider(Value,MaxNum)
	self.CurNum = Value 
...
function MysterMerchantBuyPropsWinNewView:IsCurNumMax(CurNum,MaxNum)
...
function MysterMerchantBuyPropsWinNewView:OnClickedConfirmBtn()
	--满足购买和使用条件
...
function MysterMerchantBuyPropsWinNewView:GetTipsContent()
	local Tips = ""
...
function MysterMerchantBuyPropsWinNewView:ScoreIsEnough(PriceInfo)
...
function MysterMerchantBuyPropsWinNewView:UpdatePriceInfo(Value)
	for i = 1,#PriceValueInfo do
...
--二次弹窗确认后继续购买
function MysterMerchantBuyPropsWinNewView:GoonBuy()
...
function MysterMerchantBuyPropsWinNewView:UpdateTextColor()
...
function MysterMerchantBuyPropsWinNewView:BagCapacityIsEnough()
...
function MysterMerchantBuyPropsWinNewView:OnClickedBtnSlot()
	--ItemTipsUtil.CurrencyTips(self.ItemID, false, self.PanelHQ)
	self:SetBindState()
end

function MysterMerchantBuyPropsWinNewView:OnClickedBtnNumber1()
	local AddVlue = 10
...
function MysterMerchantBuyPropsWinNewView:OnClickedBtnNumber2()
	local AddVlue = 10
...
function MysterMerchantBuyPropsWinNewView:OnClickedBtnTips1()
	local Tips = LSTR(1110023)--已达到最小数量，不能再减少
	MsgTipsUtil.ShowTips(Tips)
end

function MysterMerchantBuyPropsWinNewView:OnClickedBtnTips2()
	local Tips = LSTR(1110022)--已达到最大数量，不能再增加
	MsgTipsUtil.ShowTips(Tips)
end

function MysterMerchantBuyPropsWinNewView:OnClickedBtnCancel()
	self:Hide()
end

function MysterMerchantBuyPropsWinNewView:ShowPirceTips(Index)
...
function MysterMerchantBuyPropsWinNewView:SetBuyBtnState(Value, IsCanBuy)
	if IsCanBuy then
		if Value then
...
return MysterMerchantBuyPropsWinNewView