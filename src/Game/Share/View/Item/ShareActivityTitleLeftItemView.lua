...
Date: 2024-12-13 17:10:22
LastEditors: jususchen jususchen@tencent.com
LastEditTime: 2024-12-13 17:13:57
FilePath: \Script\Game\Share\View\Item\ShareActivityTitleLeftItemView.lua
...
---@class ShareActivityTitleLeftItemView : UIView
...
local ShareActivityTitleLeftItemView = LuaClass(UIView, true)

function ShareActivityTitleLeftItemView:Ctor()
...
function ShareActivityTitleLeftItemView:OnRegisterSubView()
...
function ShareActivityTitleLeftItemView:UpdateData(Cfg)
...
return ShareActivityTitleLeftItemView