...
---@class FacebookShareObject : ShareObject
local FacebookShareObject = LuaClass(ShareObject, nil)

function FacebookShareObject:Ctor()
    self:SetIcon(ShareDefine.SharePlatformIcons.FACEBOOK)
end

function FacebookShareObject:IsAppToShareInstalled()
    -- #TODO
end

function FacebookShareObject:GetShareChannel()
    return "Facebook"
end

function FacebookShareObject:CanShareImage()
    return true
end


return FacebookShareObject