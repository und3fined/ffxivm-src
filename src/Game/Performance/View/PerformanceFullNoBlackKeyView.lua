...
---@class PerformanceFullNoBlackKeyView : UIView
...
local PerformanceFullNoBlackKeyView = LuaClass(UIView, true)

function PerformanceFullNoBlackKeyView:Ctor()
...
function PerformanceFullNoBlackKeyView:OnRegisterSubView()
...
function PerformanceFullNoBlackKeyView:OnInit()
...
function PerformanceFullNoBlackKeyView:OnDestroy()

end

function PerformanceFullNoBlackKeyView:OnShow()

end

function PerformanceFullNoBlackKeyView:OnHide()

end

function PerformanceFullNoBlackKeyView:OnRegisterUIEvent()

end

function PerformanceFullNoBlackKeyView:OnRegisterGameEvent()

end

function PerformanceFullNoBlackKeyView:OnRegisterBinder()

end

return PerformanceFullNoBlackKeyView