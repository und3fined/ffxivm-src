...
---@class PerformanceFullKeyView : UIView
...
local PerformanceFullKeyView = LuaClass(UIView, true)

function PerformanceFullKeyView:Ctor()
...
function PerformanceFullKeyView:OnRegisterSubView()
...
function PerformanceFullKeyView:OnInit()
...
function PerformanceFullKeyView:OnDestroy()

end

function PerformanceFullKeyView:OnShow()

end

function PerformanceFullKeyView:OnHide()

end

function PerformanceFullKeyView:OnRegisterUIEvent()

end

function PerformanceFullKeyView:OnRegisterGameEvent()

end

function PerformanceFullKeyView:OnRegisterBinder()

end

return PerformanceFullKeyView