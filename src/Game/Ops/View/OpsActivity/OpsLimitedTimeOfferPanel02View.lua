...
---@class OpsLimitedTimeOfferPanel02View : UIView
...
local OpsLimitedTimeOfferPanel02View = LuaClass(OpsLimitedTimeOfferBaseView, true)

function OpsLimitedTimeOfferPanel02View:Ctor()
...
function OpsLimitedTimeOfferPanel02View:OnRegisterSubView()
...
return OpsLimitedTimeOfferPanel02View