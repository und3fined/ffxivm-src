...
---@class CommDropDownListNewView : UIView
---AUTO GENERATED CODE 3 BEGIN, PLEASE DON'T MODIFY
---@field DropListPanel UFCanvasPanel
---@field ExtendItem CommDropDownExtendItemView
---@field ExtendPanel UFCanvasPanel
---@field ImgExtendLine UFImage
...
function CommDropDownListNewView:OnRegisterSubView()
	--AUTO GENERATED CODE 2 BEGIN, PLEASE DON'T MODIFY
	self:AddSubView(self.ExtendItem)
	--AUTO GENERATED CODE 2 END, PLEASE DON'T MODIFY
end

function CommDropDownListNewView:OnInit()
	self.IsFlip = false
...
function CommDropDownListNewView:OnDestroy()

end

function CommDropDownListNewView:OnShow()
...
function CommDropDownListNewView:OnHide()
...
function CommDropDownListNewView:OnRegisterUIEvent()

end

function CommDropDownListNewView:OnRegisterGameEvent()
	self:RegisterGameEvent(_G.EventID.PreprocessedMouseButtonDown, self.OnPreprocessedMouseButtonDown)
end

function CommDropDownListNewView:OnRegisterBinder()
	--self:RegisterBinders(self.ViewModel, self.Binders)
end

-- function CommDropDownListNewView:SetExtendItem(ExtendItemData)
...
function CommDropDownListNewView:SetExtendItem( Name, IsVisible, ClickCBFunc )
...
function CommDropDownListNewView:SetSelectedIndex(SelectedIndex)
	self.TableViewAdapter:SetSelectedIndex(SelectedIndex)
end

function CommDropDownListNewView:OnItemSelectChanged(Index, ItemData, ItemView, IsByClick)
...
function CommDropDownListNewView:OnPreprocessedMouseButtonDown(MouseEvent)
	local Params = self.Params
	if Params == nil then
		return
	end
...
function CommDropDownListNewView:CancelSelected()
	self.TableViewAdapter:CancelSelected()

end

return CommDropDownListNewView