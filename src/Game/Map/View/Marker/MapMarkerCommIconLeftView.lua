...
---@class MapMarkerCommIconLeftView : MapMarkerCommIconBaseView
...
local MapMarkerCommIconLeftView = LuaClass(MapMarkerCommIconBaseView, true)

function MapMarkerCommIconLeftView:Ctor()
...
function MapMarkerCommIconLeftView:OnRegisterSubView()
	--AUTO GENERATED CODE 2 BEGIN, PLEASE DON'T MODIFY
	--AUTO GENERATED CODE 2 END, PLEASE DON'T MODIFY
end

return MapMarkerCommIconLeftView