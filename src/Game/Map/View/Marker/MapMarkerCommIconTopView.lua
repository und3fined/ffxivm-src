...
---@class MapMarkerCommIconTopView : MapMarkerCommIconBaseView
...
local MapMarkerCommIconTopView = LuaClass(MapMarkerCommIconBaseView, true)

function MapMarkerCommIconTopView:Ctor()
...
function MapMarkerCommIconTopView:OnRegisterSubView()
	--AUTO GENERATED CODE 2 BEGIN, PLEASE DON'T MODIFY
	--AUTO GENERATED CODE 2 END, PLEASE DON'T MODIFY
end

function MapMarkerCommIconTopView:OnRegisterGameEvent()
	self.Super:OnRegisterGameEvent()
	self:RegisterGameEvent(EventID.UpdateChocoboTransportNpcBookStatus, self.OnUpdateView)
	self:RegisterGameEvent(EventID.MagicCardUpdateNPCHudIcon, self.OnUpdateView)
end

function MapMarkerCommIconTopView:OnShow()
	self.Super:OnShow()
	self:OnUpdateView()
end

function MapMarkerCommIconTopView:OnUpdateView()
	...
	if MapMarker then
		MapMarker:UpdateView()
		ViewModel:UpdateVM(MapMarker)
	end
end

return MapMarkerCommIconTopView