...
---@class MapMarkerCommIconRightView : MapMarkerCommIconBaseView
...
local MapMarkerCommIconRightView = LuaClass(MapMarkerCommIconBaseView, true)

function MapMarkerCommIconRightView:Ctor()
...
function MapMarkerCommIconRightView:OnRegisterSubView()
	--AUTO GENERATED CODE 2 BEGIN, PLEASE DON'T MODIFY
	--AUTO GENERATED CODE 2 END, PLEASE DON'T MODIFY
end

return MapMarkerCommIconRightView