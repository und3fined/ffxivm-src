...
function FieldTestPanelView:OnInit()
	...
	self.TabVMList:AddByValue({Key = 2, Name = "Monster", PanelView = self, CallBack = self.OnSelectedTabIndex})
	self.TabVMList:AddByValue({Key = 3, Name = "Gathering Nodes", PanelView = self, CallBack = self.OnSelectedTabIndex})
	self.TabVMList:AddByValue({Key = 4, Name = "FATE", PanelView = self, CallBack = self.OnSelectedTabIndex})
	self.TabVMList:AddByValue({Key = 5, Name = "Sound Effects", PanelView = self, CallBack = self.OnSelectedTabIndex})
	self.TabVMList:AddByValue({Key = 6, Name = "Weather", PanelView = self, CallBack = self.OnSelectedTabIndex})
	self.TabVMList:AddByValue({Key = 7, Name = "Chocobo", PanelView = self, CallBack = self.OnSelectedTabIndex})
	self.TabVMList:AddByValue({Key = 8, Name = "Aetheryte", PanelView = self, CallBack = self.OnSelectedTabIndex})
	self.TabVMList:AddByValue({Key = 9, Name = "Fishing Spots", PanelView = self, CallBack = self.OnSelectedTabIndex})
	self.TabVMList:AddByValue({Key = 10, Name = "Aether Currents", PanelView = self, CallBack = self.OnSelectedTabIndex})
	self.TabVMList:AddByValue({Key = 11, Name = "Sightseeing Log", PanelView = self, CallBack = self.OnSelectedTabIndex})
	self.TabVMList:AddByValue({Key = 12, Name = "Treasure Chests", PanelView = self, CallBack = self.OnSelectedTabIndex})
