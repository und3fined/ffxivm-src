...
---@class MessageBoardPanelView : UIView
...
local MessageBoardPanelView = LuaClass(UIView, true)

function MessageBoardPanelView:Ctor()
...
function MessageBoardPanelView:OnRegisterSubView()
	--AUTO GENERATED CODE 2 BEGIN, PLEASE DON'T MODIFY
	self:AddSubView(self.CloseBtn)
	--AUTO GENERATED CODE 2 END, PLEASE DON'T MODIFY
end

function MessageBoardPanelView:OnInit()
...
function MessageBoardPanelView:OnDestroy()

end

function MessageBoardPanelView:OnShow()
	if self.TableViewMsgList ~= nil then
		self.TableViewMsgList:ClearTableItems()
	end
...
function MessageBoardPanelView:OnHide()
	BoardVM.BoardList = nil
	--BoardVM:ClearNew()
end

function MessageBoardPanelView:OnRegisterUIEvent()
	UIUtil.AddOnClickedEvent(self, self.BtnInput, self.OnBoardInput)
end

function MessageBoardPanelView:OnRegisterGameEvent()
...
function MessageBoardPanelView:OnRegisterBinder()
	local Binders = {
...
function MessageBoardPanelView:OnBoardDataChange(Params)
	BoardVM.BoardList = nil
...
-- BoardList数据更新的回调
function MessageBoardPanelView:OnBoardListChange(Param)
	self.ViewModel:UpdateBoardList(Param)
end

-- 列表选中项更改的回调
function MessageBoardPanelView:OnBoardTableViewSelectChange(Index, ItemData, ItemView)
	-- body
end

-- 点击输入框的回调
function MessageBoardPanelView:OnBoardInput()
