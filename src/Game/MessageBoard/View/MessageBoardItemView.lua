...
---@class MessageBoardItemView : UIView
...
---@field TestSelf UFTextBlock
---@field TextMsg UFTextBlock
---@field TextOther UFTextBlock
---@field TextPickValue UFTextBlock
---AUTO GENERATED CODE 3 END, PLEASE DON'T MODIFY
local MessageBoardItemView = LuaClass(UIView, true)

function MessageBoardItemView:Ctor()
...
function MessageBoardItemView:OnRegisterSubView()
	--AUTO GENERATED CODE 2 BEGIN, PLEASE DON'T MODIFY
	self:AddSubView(self.PlayerHeadSlot)
	--AUTO GENERATED CODE 2 END, PLEASE DON'T MODIFY
end

function MessageBoardItemView:OnInit()

end

function MessageBoardItemView:OnDestroy()

end

function MessageBoardItemView:OnShow()

end

function MessageBoardItemView:OnHide()

end

function MessageBoardItemView:OnRegisterUIEvent()
...
function MessageBoardItemView:OnRegisterGameEvent()

end

function MessageBoardItemView:OnRegisterBinder()
...
function MessageBoardItemView:OnPlayerChange()
	self.PlayerHeadSlot:UpdateIcon(self.ViewModel.PlayerID)
end

function MessageBoardItemView:OnClickPickButton()
...
function MessageBoardItemView:OnClickDeleteButton()
...
function MessageBoardItemView:OnTipsSureDelete()
...
function MessageBoardItemView:OnClickReportButton()
