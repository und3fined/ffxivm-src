...
---@class GoldSaucerTheFinerMinerShootingTipsItemView : UIView
...
local GoldSaucerTheFinerMinerShootingTipsItemView = LuaClass(UIView, true)

function GoldSaucerTheFinerMinerShootingTipsItemView:Ctor()
...
function GoldSaucerTheFinerMinerShootingTipsItemView:OnRegisterSubView()
	--AUTO GENERATED CODE 2 BEGIN, PLEASE DON'T MODIFY
	--AUTO GENERATED CODE 2 END, PLEASE DON'T MODIFY
end

function GoldSaucerTheFinerMinerShootingTipsItemView:OnInit()

end

function GoldSaucerTheFinerMinerShootingTipsItemView:OnDestroy()

end

function GoldSaucerTheFinerMinerShootingTipsItemView:OnShow()

end

function GoldSaucerTheFinerMinerShootingTipsItemView:OnHide()

end

function GoldSaucerTheFinerMinerShootingTipsItemView:OnRegisterUIEvent()

end

function GoldSaucerTheFinerMinerShootingTipsItemView:OnRegisterGameEvent()

end

function GoldSaucerTheFinerMinerShootingTipsItemView:OnRegisterBinder()

end

function GoldSaucerTheFinerMinerShootingTipsItemView:UpdateMainPanelData(ViewModel)
...
function GoldSaucerTheFinerMinerShootingTipsItemView:IsForceGC()
	return true
end

return GoldSaucerTheFinerMinerShootingTipsItemView