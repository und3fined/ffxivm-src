---
--- Author: Alex
--- DateTime: 2025-07-04 19:48
--- Description:新增赐福模式交互物
---
...
---@class GoldSaucerCuffBlowGreenItemView : UIView
...
---@field P_EFF_particles_GoldSaucer_Cuff UUIParticleEmitter
...
local GoldSaucerCuffBlowGreenItemView = LuaClass(CuffBlowItemBase, true)

function GoldSaucerCuffBlowGreenItemView:Ctor()
	--AUTO GENERATED CODE 1 BEGIN, PLEASE DON'T MODIFY
	--self.BlowResult = nil
	--self.Btn = nil
	--self.FCanvasPanel_26 = nil
	--self.P_DX_TheFinerMiner_8 = nil
	--self.P_EFF_particles_GoldSaucer_Cuff = nil
...
function GoldSaucerCuffBlowGreenItemView:OnRegisterSubView()
	--AUTO GENERATED CODE 2 BEGIN, PLEASE DON'T MODIFY
	self:AddSubView(self.BlowResult)
	--AUTO GENERATED CODE 2 END, PLEASE DON'T MODIFY
end

function GoldSaucerCuffBlowGreenItemView:OnInit()
...
function GoldSaucerCuffBlowGreenItemView:OnDestroy()

end

function GoldSaucerCuffBlowGreenItemView:OnShow()

end

function GoldSaucerCuffBlowGreenItemView:OnHide()
	self:UnRegisterAllTimer()
	self:StopAllAnimations()
end

function GoldSaucerCuffBlowGreenItemView:OnRegisterUIEvent()
	UIUtil.AddOnClickedEvent(self, self.Btn, self.OnBtnClick)
end

function GoldSaucerCuffBlowGreenItemView:OnRegisterGameEvent()

end

function GoldSaucerCuffBlowGreenItemView:OnRegisterBinder()
	self.Super:OnRegisterBinder()
end

function GoldSaucerCuffBlowGreenItemView:OnBtnClick()
	self:OnBaseBtnClick(false)
end

function GoldSaucerCuffBlowGreenItemView.ArrivalShowTime(self)
...
function GoldSaucerCuffBlowGreenItemView.ArrivalShrinkTime(self)
	local ShrinkSp = self.ShrinkSp
	self:PlayAnimation(self.AnimWork, 0, 1, _G.UE.EUMGSequencePlayMode.Forward, ShrinkSp)
end

-- -- @type 每次更新VM时调用
function GoldSaucerCuffBlowGreenItemView:OnUpdateCallBack()
	self:OnBaseUpdateCallBack()
end

function GoldSaucerCuffBlowGreenItemView:UpdateResult(HitResult)
...
function GoldSaucerCuffBlowGreenItemView:GetViewModel()
	local Params = self.Params
	if Params == nil then
		return
	end
...
function GoldSaucerCuffBlowGreenItemView:PlayResultAnimByHitResult(HitResult, ComboNum)
    ...
    elseif HitResult == InteractResult.Perfect or HitResult == InteractResult.Excellent then
		if ComboNum > 1 then
...
function GoldSaucerCuffBlowGreenItemView:OnAnimationFinished(Anim)
	if Anim == self.AnimBurst then
		self:ResetParticles()
	end
end

function GoldSaucerCuffBlowGreenItemView:ResetParticles()
...
return GoldSaucerCuffBlowGreenItemView