...
---@class UIBinderSetProfIconSimple : UIBinder
local UIBinderSetProfIconSimple = LuaClass(UIBinder)

---Ctor
---@param View UIView
---@param NormalWidget UImage
function UIBinderSetProfIconSimple:Ctor(View, NormalWidget, BGWidget)
...
function UIBinderSetProfIconSimple:OnValueChanged(NewValue, OldValue)
...
return UIBinderSetProfIconSimple